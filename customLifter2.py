...
class PyLifter2:
    ...
    def __init__(self):
        print('starting custom lifter 2 node')

        self.service_start = rospy.Service('/external_process/trigger_detecting13', StringTrigger, self.start_handler)
        self.service_stop = rospy.Service('/external_process/stop_detecting13', StringTrigger, self.stop_handler)
