...
class PyLifter0:
    ...
    def __init__(self):
        print('starting custom lifter 0 node')

        self.service_start = rospy.Service('/external_process/trigger_detecting11', StringTrigger, self.start_handler)
        self.service_stop = rospy.Service('/external_process/stop_detecting11', StringTrigger, self.stop_handler)
