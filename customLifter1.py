...
class PyLifter1:
    ...
    def __init__(self):
        print('starting custom lifter 1 node')

        self.service_start = rospy.Service('/external_process/trigger_detecting12', StringTrigger, self.start_handler)
        self.service_stop = rospy.Service('/external_process/stop_detecting12', StringTrigger, self.stop_handler)
