...
class PyOutcity1:
    ...
    def __init__(self):
        print('starting outcity 1 node')

        self.service_start = rospy.Service('/external_process/trigger_detecting4', StringTrigger, self.start_handler)
        self.service_stop = rospy.Service('/external_process/stop_detecting4', StringTrigger, self.stop_handler)
    ...
    def start_handler(self, req):
        ...
        while(self.flag):
            print('waiting outcity1 to be clear')
            rospy.sleep(1)
