...
class PyIncity1:
    ...
    def __init__(self):
        print('starting custom incity 1 node')

        self.service_start = rospy.Service('/external_process/trigger_detecting1', StringTrigger, self.start_handler)
        self.service_stop = rospy.Service('/external_process/stop_detecting1', StringTrigger, self.stop_handler)
    ...
    def start_handler(self, req):
        ...
        while(self.flag):
            print('waiting topic incity1 to be clear')
            rospy.sleep(1)
