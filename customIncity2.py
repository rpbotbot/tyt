...
class PyIncity2:
    ...
    def __init__(self):
        print('starting custom incity 2 node')

        self.service_start = rospy.Service('/external_process/trigger_detecting2', StringTrigger, self.start_handler)
        self.service_stop = rospy.Service('/external_process/stop_detecting2', StringTrigger, self.stop_handler)
    ...
    def start_handler(self, req):
        ...
        while(self.flag):
            print('waiting topic incity2 to be clear')
            rospy.sleep(1)
