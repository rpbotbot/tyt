...
class PyConvDorong:
    ...
    def __init__(self):
        print('starting custom conveyor dorong node')

        self.service_start = rospy.Service('/external_process/trigger_detecting9', StringTrigger, self.start_handler)
        self.service_stop = rospy.Service('/external_process/stop_detecting9', StringTrigger, self.stop_handler)
        ...
        self.pesan = String()
        self.pesan.data = "conveyor=dorong"
    ...
    def start_handler(self, req):
        ...
        print("Topik conveyor=dorong terkirim!")
